...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" style="width:30%">
    <div class="modal-content">
      ...
      <form role="form" action="email1.php" method="post">
...
<div class="slideout-menu">
	...
	<a href="Carpenters.php"><img width=150 height=150 src="carpenter.jpg" style="margin-left:20px"/></a>
	 ...
	 <div id="blog" class="row">                 
            ...
            <nav class="nav-sidebar" style="position:fixed; top:126px">
                <ul class="nav">
                    ...
                    <li class="nav-divider" style="color:#000000"></li>														
                    </ul>
            </nav>
        </div>
				 <div class="MyPage">
				 <div class="col-md-10">				 
					<a id="list1" class="list-group-item" style="height:225px">						
					 	...
					 	<div class="col-lg-6">
							...
							<br>
							<button type="button" class="btn btn-default " style="text-align:center; margin-left:10px; margin-top:40px;" data-toggle="modal" data-target="#myModal3">  Send Request Now! </button>								</a>				   				                  				 
							<a id="list3" class="list-group-item" style="height:225px">						
